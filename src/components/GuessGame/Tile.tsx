...
export const Tile = ({ letter, corret, contains, wrong, className }: tileProps) => {
	return (
		<span
			className={cn(
				`flex justify-center items-center border-4 flex-1 max-w-28 aspect-[7/8] rounded-md text-2xl font-extrabold border-primary bg-muted text-primary transition-all sm:text-3xl md:text-4xl`,
